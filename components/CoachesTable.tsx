...
export default function CoachesTable({ initialCoaches }: { initialCoaches: CoachType[] }) {
      ...
      <tbody className="divide-y divide-gray-200">
        {coaches.map(coach => (
          <tr key={coach.id} className="hover:bg-gray-50 transition-colors">
            ...
            <td className="px-4 py-2">
              <Link href={`/dashboard/list-coach/${coach.id}`} className="text-blue-600 hover:underline">
                Edit
              </Link>
            </td>
          </tr>
