...
const HomeBanner = () => {
  ...
  <div className='relative flex items-center justify-center mt-10 md:mt-0'>
    ...
    <div className='absolute top-20 left-10 rounded-lg shadow-lg 
    ...
    <div className='absolute top-20 -right-2 rounded-lg shadow-lg 
            p-[2px] bg-gradient-to-r from-red-500 to-orange-500
            transform transition duration-300 ease-in-out hover:scale-110'>
      <div className='bg-black/80 text-white px-4 py-2 rounded-lg'>
    ...
    <div className='absolute -bottom-8 left-5 rounded-lg shadow-lg 
            p-[2px] bg-gradient-to-r from-red-500 to-orange-500
            transform transition duration-300 ease-in-out hover:scale-110'>
      <div className='bg-black/80 text-white px-4 py-2 rounded-lg'>
    ...
    <div className='absolute bottom-0 right-1 rounded-lg shadow-lg 
            p-[2px] bg-gradient-to-r from-red-500 to-orange-500
            transform transition duration-300 ease-in-out hover:scale-110'>
      <div className='bg-black/80 text-white px-4 py-2 rounded-lg'>
        + 1500 <br /> Trainers
