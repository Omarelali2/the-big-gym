      ...
      <div className="flex-1 flex flex-col justify-between">
        ...
        <div className="flex flex-col md:flex-row gap-6 mt-6">
          ...
          <Link
            ...
            className="inline-block px-8 py-4 text-xl font-bold text-white bg-red-600 rounded-full hover:bg-red-700 transition-all duration-300 shadow-lg transform hover:-translate-y-1 hover:scale-105"
          >
            💬 Chat with Coach
          </Link>
        </div>
