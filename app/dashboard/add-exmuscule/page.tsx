        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
          ...
          <div>
            ...
            <input
              ...
              className='border p-2 rounded-lg bg-gray-900 w-full'
            />
          </div>
          ...
          <div>
            ...
            {workoutTypes.length > 0 ? (
              ...
              <p className='text-gray-400 italic'>
                No workout types available. Please add one first.
              </p>
            )}
          </div>
          ...
          <button
            type='submit'
            disabled={loading}
            className='bg-red-500 hover:bg-red-600 transition-colors p-3 rounded-lg font-bold text-lg mt-4'
          >
